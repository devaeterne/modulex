...
replaceOnce(roadmap,
`## General Settings\n\n- [~] General Settings alanını test edip tamamla.\n  - [x] Company profile\n  - [x] Company contact structure\n  - [x] Location / Hours\n  - [x] Logos / Branding\n  - [ ] Localization\n  - [ ] Tax Rules\n  - [ ] Document settings`,
`## General Settings\n\n- [x] General Settings alanını test edip tamamla.\n  - [x] Company profile\n  - [x] Company contact structure\n  - [x] Location / Hours\n  - [x] Logos / Branding\n  - [x] Localization\n  - [x] Tax Rules\n  - [x] Document settings\n- [x] SET-A1 — Company/public profile ownership\n- [x] SET-A2 — Locale/timezone/currency\n- [x] SET-A3 — Tax rules\n- [x] SET-A4 — Document settings\n- [x] SET-A5 — Settings exit gate`);
