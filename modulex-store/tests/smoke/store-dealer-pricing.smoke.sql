...
declare
  ...
  v_group_good uuid;
  v_group_inactive uuid;
  v_group_internal uuid;
  v_group_no_orders uuid;
  v_dealer_a uuid;
  v_dealer_b uuid;
  v_customer_a uuid;
...
begin
  ...
  insert into public.price_groups(system_key,name,sort_order,is_active,available_for_orders,internal_only)
  values ('p15-inactive-'||v_suffix,'P1.5 Inactive',901,false,true,false) returning id into v_group_inactive;
  insert into public.price_groups(system_key,name,sort_order,is_active,available_for_orders,internal_only)
  values ('p15-internal-'||v_suffix,'P1.5 Internal',902,true,true,true) returning id into v_group_internal;
  insert into public.price_groups(system_key,name,sort_order,is_active,available_for_orders,internal_only)
  values ('p15-noorders-'||v_suffix,'P1.5 No Orders',903,true,false,false) returning id into v_group_no_orders;
  ...
  values (v_dealer_a,v_email_da,'never_invited',true),(v_dealer_b,v_email_db,'never_invited',true),(v_customer_a,v_email_ca,'never_invited',true);
  ...
  update public.customers set price_group_id=null where id=v_dealer_a;
  v_result := public.get_store_dealer_pricing_context();
  ...
  update public.customers set price_group_id=v_group_inactive where id=v_dealer_a;
  ...
  update public.customers set price_group_id=v_group_internal where id=v_dealer_a;
  ...
  update public.customers set price_group_id=v_group_no_orders where id=v_dealer_a;
