...
revoke all on function public.get_products_page_v2(text,uuid,uuid,text,text,text,text,integer,integer) from public,anon;
grant execute on function public.get_products_page_v2(text,uuid,uuid,text,text,text,text,integer,integer) to authenticated;
