...
export default function Navbar() {
  ...
  const closeAllDropdowns = () => {
    navRef.current
      ?.querySelectorAll(".nav-item.show-dropdown")
      .forEach((item) => item.classList.remove("show-dropdown"));
  };
  ...
  return (
    <nav
      ref={navRef}
      className={`navbar navbar-expand-lg custom-navbar ${isMobileOpen ? "menu-open" : ""}`}
    >
      <div className="container">
        <Link href="/" className="logo" onClick={handleLinkClick}>
          <img src="/assets/images/logo.png" className="logo" alt="Oakwell Cabinetry" />
          <img
            src="/assets/images/logo-white.png"
            className="logo-dark"
            alt="Oakwell Cabinetry"
          />
        </Link>

        <ul
          className={`navbar-nav custom-nav ${isMobileOpen ? "active" : ""}`}
          id="mobileNav"
        >
          ...
          <li className="nav-item">
            <Link className="nav-link" href="/products" onClick={handleLinkClick}>
              Products
            </Link>
          </li>
          <li className="nav-item services-dd">
            <Link className="nav-link" href="/services" onClick={handleLinkClick}>
              Services
            </Link>
          </li>
          <li className="nav-item">
          ...
          <li className="nav-item nav-new-dd">
            <Link className="nav-link" href="/blog" onClick={handleLinkClick}>
              Blog
            </Link>
          </li>
        </ul>

        <Link href="/contact" className="cta-nav" onClick={handleLinkClick}>
          Contact Us
        </Link>
