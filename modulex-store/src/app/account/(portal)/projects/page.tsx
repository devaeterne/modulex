...
export default async function AccountProjectsPage({ searchParams }: { searchParams: ProjectsSearchParams }) {
  ...
  if (page > 1 && pageData.totalCount > 0 && offset >= pageData.totalCount) {
    ...
    redirect(lastPage === 1 ? "/account/projects" : `/account/projects?page=${lastPage}`);
  }
