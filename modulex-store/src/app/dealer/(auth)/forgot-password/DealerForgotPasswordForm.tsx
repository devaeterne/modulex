...
export default function DealerForgotPasswordForm() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-4">
        <label className="form-label" htmlFor="dealer-reset-email">Email</label>
        <input
          id="dealer-reset-email"
      ...
      <button className="btn btn-dark w-100" type="submit" disabled={busy}>
        {busy ? "Sending…" : "Send reset link"}
      </button>

      <div className="text-center mt-4">
        <Link href="/dealer/login" className="small text-secondary">Back to sign in</Link>
      </div>
    </form>
  );
}
