...
// SET-A5 final exit gate is explicit in the roadmap.
...
assert.match(roadmap, /- \[x\] General Settings alanını test edip tamamla\./, "General Settings parent must be closed");
