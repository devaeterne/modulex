...
for (const [markup, id, message] of [
  ...
  ['<Field label="Applied Commission (%)" htmlFor="new-order-payment-commission"', "new-order-payment-commission", "New Order Applied Commission"],
...
for (const [markup, id, message] of [
  ...
  ['<Field label="Applied Commission (%)" htmlFor="edit-order-payment-commission"', "edit-order-payment-commission", "Edit Order Applied Commission"],
