...
const expectedInventory = [
  ...
  "src/app/api/admin/email-notifications/monitor/route.ts",
  ...
  "src/app/api/admin/projects/[projectId]/documents/[artifactId]/download/route.ts",
  "src/app/api/admin/projects/[projectId]/proposals/[proposalId]/revisions/[revisionId]/accepted-artifact/route.ts",
  "src/app/api/admin/projects/[projectId]/proposals/[proposalId]/revisions/[revisionId]/pdf/route.ts",
  "src/app/api/admin/projects/import/route.ts",
...
assert.equal(routeInventory.length, 41, `Expected 41 API route files, found ${routeInventory.length}`);
