...
const navItems: NavItem[] = [
  ...
  { icon: <CalenderIcon />, name: "Calendar", path: "/calendar", permission: "calendar.view" },
  {
    ...
    subItems: [
      ...
      { name: "Vendor Imports", path: "/products/vendor-imports", permission: "products.manage" },
...
const managementItems: NavItem[] = [
  {
    ...
    subItems: [
      ...
      { name: "Customer Receipts", path: "/finance/customer-receipts", permission: "finance.view", new: true },
      { name: "Vendor Management", path: "/finance/vendors", permission: "finance.view" },
      { name: "Vendor Bills", path: "/finance/bills", permission: "finance.view" },
      ...
      { name: "Finance Reports", path: "/finance/reports", permission: "finance.view", new: true },
